// app/javascript/packs/new_door_installation.js

document.addEventListener("DOMContentLoaded", function() {
    console.log("new_door_installation.js is loaded");
  
    const daySelect = document.querySelector('#door_installation_installation_date_3i');
    const monthSelect = document.querySelector('#door_installation_installation_date_2i');
    const yearSelect = document.querySelector('#door_installation_installation_date_1i');
